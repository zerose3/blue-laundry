...
<?php $__env->startSection('title', 'Dashboard Admin - Blue-Laundry'); ?>
...
<div class="p-6 lg:p-8 space-y-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <span class="text-sm text-slate-500 dark:text-slate-400"><?php echo e(now()->format('d F Y')); ?></span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="glass-card rounded-2xl p-6 hover:scale-[1.02] transition-transform duration-300">
            <div class="flex items-center justify-between mb-4">
                <div class="w-12 h-12 bg-<?php echo e($stat['color']); ?>-100 dark:bg-<?php echo e($stat['color']); ?>-900/30 rounded-xl flex items-center justify-center">
                    <i class="fas <?php echo e($stat['icon']); ?> text-<?php echo e($stat['color']); ?>-600 dark:text-<?php echo e($stat['color']); ?>-400 text-xl"></i>
                </div>
            ...
            <p class="text-2xl font-bold text-slate-900 dark:text-white mb-1"><?php echo e($stat['value']); ?></p>
            <p class="text-sm text-slate-500 dark:text-slate-400"><?php echo e($stat['label']); ?></p>
        </div>
    ...
    <div class="grid lg:grid-cols-3 gap-6">
        ...
        <div class="glass-card rounded-2xl p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-4 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-slate-900 dark:text-white truncate"><?php echo e($order->user->name); ?></p>
                        <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo e($order->order_code); ?></p>
                    </div>
                    <span class="text-xs font-medium px-2 py-1 rounded-lg bg-<?php echo e($order->status_color); ?>-100 dark:bg-<?php echo e($order->status_color); ?>-900/30 text-<?php echo e($order->status_color); ?>-600 dark:text-<?php echo e($order->status_color); ?>-400">
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="block mt-4 text-center text-sm text-primary-600 dark:text-primary-400 hover:underline">
                Lihat Semua Pesanan
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blue-laundry\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
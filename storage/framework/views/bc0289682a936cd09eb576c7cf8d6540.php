    ...
    <div id="chat-messages" class="flex-1 overflow-y-auto bg-slate-900/50 p-4 space-y-3">
        ...
        <div class="flex gap-2">
            ...
            <div class="bg-slate-700/50 rounded-xl rounded-tl-none p-3 max-w-[85%]">
                <p class="text-white text-sm">Halo <?php echo e(auth()->user()->name); ?>! 👋 Saya bisa bantu cek status laundry, harga, dan tips perawatan.</p>
            </div>
        </div>

        <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="flex gap-2 <?php echo e($msg->role === 'user' ? 'flex-row-reverse' : ''); ?>">
            ...
            <div class="w-6 h-6 bg-slate-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                <span class="text-white text-xs font-bold"><?php echo e(substr(auth()->user()->name, 0, 1)); ?></span>
            </div>
            <?php endif; ?>
            <div class="<?php echo e($msg->role === 'user' ? 'bg-blue-600/20 rounded-tr-none' : 'bg-slate-700/50 rounded-tl-none'); ?> rounded-xl p-3 max-w-[85%]">
                <p class="text-white text-sm"><?php echo e($msg->message); ?></p>
            </div>
        </div>
...
async function clearChat() {
    ...
    await fetch('<?php echo e(route("customer.ai.clear")); ?>', {
        method: 'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blue-laundry\resources\views/customer/ai/chatbot.blade.php ENDPATH**/ ?>
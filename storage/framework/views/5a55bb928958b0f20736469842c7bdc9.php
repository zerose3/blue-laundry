...
<?php $__env->startSection('title', 'Tracking Laundry'); ?>
...
<section class="pt-32 pb-20 min-h-screen">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="glass-card rounded-3xl p-8 mb-8 animate-on-scroll">
            <form action="<?php echo e(route('tracking.search')); ?>" method="POST" class="flex flex-col sm:flex-row gap-4">
                <?php echo csrf_field(); ?>
        ...
        <div class="glass-card rounded-3xl p-8 animate-on-scroll">
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-xl font-mono font-bold text-slate-900 dark:text-white"><?php echo e($order->order_code); ?></p>
                </div>
                <div class="text-right">
                    <p class="text-sm text-slate-500 dark:text-slate-400 mb-1">Status</p>
                    <span class="inline-flex px-4 py-2 rounded-xl text-sm font-bold bg-<?php echo e($order->status_color); ?>-100 dark:bg-<?php echo e($order->status_color); ?>-900/30 text-<?php echo e($order->status_color); ?>-600 dark:text-<?php echo e($order->status_color); ?>-400">
            ...
            <div class="relative mb-8">
                <div class="h-2 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                    <div class="h-full bg-gradient-to-r from-primary-500 to-primary-600 rounded-full transition-all duration-1000" style="width: <?php echo e($order->status_progress); ?>%"></div>
                </div>
            ...
            <div class="grid sm:grid-cols-2 gap-4 text-sm">
                <div class="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50">
                    ...
                    <p class="font-semibold text-slate-900 dark:text-white"><?php echo e($order->user->name); ?></p>
                </div>
                <div class="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50">
                    <p class="text-slate-500 dark:text-slate-400 mb-1">Layanan</p>
                    <p class="font-semibold text-slate-900 dark:text-white"><?php echo e($order->service->name); ?></p>
                </div>
                <div class="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50">
                    <p class="text-slate-500 dark:text-slate-400 mb-1">Berat</p>
                    <p class="font-semibold text-slate-900 dark:text-white"><?php echo e($order->weight); ?> kg</p>
                </div>
                <div class="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50">
                    <p class="text-slate-500 dark:text-slate-400 mb-1">Total</p>
                    <p class="font-semibold text-primary-600 dark:text-primary-400">Rp <?php echo e(number_format($order->total_price)); ?></p>
                </div>
            </div>
        </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blue-laundry\resources\views/tracking.blade.php ENDPATH**/ ?>
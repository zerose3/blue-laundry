...
<?php $__env->startSection('content'); ?>
    ...
    <p class="mt-6 text-center text-sm text-slate-600 dark:text-slate-400">
        Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-primary-600 font-semibold hover:underline">Masuk</a>
    </p>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\blue-laundry\resources\views/auth/register.blade.php ENDPATH**/ ?>
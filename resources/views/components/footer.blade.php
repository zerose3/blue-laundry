        ...
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-slate-500 dark:text-slate-400">
                    <li><a href="{{ route('services') }}" class="hover:text-primary-600 transition-colors">Cuci Kering</a></li>
                    <li><a href="{{ route('services') }}" class="hover:text-primary-600 transition-colors">Cuci Setrika</a></li>
                    <li><a href="{{ route('services') }}" class="hover:text-primary-600 transition-colors">Dry Cleaning</a></li>
                    <li><a href="{{ route('services') }}" class="hover:text-primary-600 transition-colors">Cuci Sepatu</a></li>
                </ul>
            </div>
            <div>

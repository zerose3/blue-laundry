...
<meta name="user-initial" content="{{ substr(auth()->user()->name, 0, 1) }}">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 glass border-r border-slate-700/50 flex-shrink-0 hidden lg:flex flex-col h-screen">
            ...
            <nav class="flex-1 p-4 overflow-y-auto">
                ...
                <a href="{{ route('customer.orders.create') }}" class="sidebar-link {{ request()->routeIs('customer.orders.create') ? 'active' : '' }}">
                    <i class="fas fa-plus-circle w-5 text-center"></i>
                    <span class="font-medium">Pesan Baru</span>
                </a>
                <a href="{{ route('customer.orders.index') }}" class="sidebar-link {{ request()->routeIs('customer.orders.index') ? 'active' : '' }}">
                    <i class="fas fa-shopping-bag w-5 text-center"></i>
                    <span class="font-medium">Pesanan Saya</span>
                </a>
                <a href="{{ route('customer.ai.chatbot') }}" class="sidebar-link {{ request()->routeIs('customer.ai.*') ? 'active' : '' }}">
